...
export const data = [
  ...
  },
  {
    productID: 3,
    category: 'Thực phẩm chức năng',
    name: 'Viên Uống Bổ Sung Canxi Anica Phytextra Ngừa Loãng Xương, Còi Xương (Hộp 60 Viên)',
    price: 517000,
    made_in: 'Pháp',
...
export const CATEGORIES = [
  {
    image: IMAGES.categories.thuc_pham_chuc_nang,
    category: 'Thực phẩm chức năng',
    sub_categories: [
      {
  ...
  {
    image: IMAGES.categories.cham_soc_ca_nhan,
    category: 'Chăm sóc cá nhân',
    sub_categories: [
      {
  ...
  {
    image: IMAGES.categories.dung_cu_y_te,
    category: 'Dụng cụ y tế',
    sub_categories: [
      {
        name: 'Dụng cụ y tế',
  ...
  {
    image: IMAGES.categories.duoc_my_pham,
    category: 'Dược mỹ phẩm',
    sub_categories: [
      {
  ...
  {
    image: IMAGES.categories.thuoc,
    category: 'Thuốc',
    sub_categories: [
      {
        name: 'Thuốc kháng sinh',
        image:
          'https://nhathuoclongchau.com/images/category/20220323150306-7435.png',
      },
      {
        name: 'Mắt',
        image:
          'https://images.fpt.shop/unsafe/fit-in/200x200/filters:quality(100):fill(white)/nhathuoclongchau.com/upload/images/filtercate/bao-ve-mat.png',
      },
      {
        name: 'Hệ cơ xương',
        image:
          'https://images.fpt.shop/unsafe/fit-in/200x200/filters:quality(100):fill(white)/nhathuoclongchau.com/upload/images/filtercate/xuong-khop.png',
      },
      {
        name: 'Hệ hô hấp',
        image:
          'https://images.fpt.shop/unsafe/fit-in/200x200/filters:quality(100):fill(white)/nhathuoclongchau.com/upload/images/filtercate/ho-hap-xoang.png',
      },
      {
        name: 'Thuốc da liễu',
        image:
          'https://images.fpt.shop/unsafe/fit-in/200x200/filters:quality(100):fill(white)/nhathuoclongchau.com/upload/images/filtercate/da.png',
      },
      {
        name: 'Dị ứng & hệ miễn dịch',
        image:
          'https://nhathuoclongchau.com/images/category/20220323150350-2034.png',
      },
      {
        name: 'Thuốc giải độc, khử độc và hỗ trợ',
        image:
          'https://images.fpt.shop/unsafe/fit-in/200x200/filters:quality(100):fill(white)/nhathuoclongchau.com/upload/images/filtercate/ho-tro-trao-doi-chat.png',
      },
    ],
  },
];
